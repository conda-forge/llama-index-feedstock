...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/llama-index-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/llama-index-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add llama-index
# for installing globally
pixi global install llama-index
```
...
It is possible to list all of the versions of `llama-index` available on your platform:
...
```
pixi search llama-index --channel conda-forge
```
